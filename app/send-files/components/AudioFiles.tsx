          ...
          <div className="bg-white p-8 rounded-[10px]">
            ...
            {selectedFiles.length > 0 && (
              <div className="space-y-2">
                <h3 className="text-black font-light mt-2">
                ...
                {selectedFiles.map(({ file, id }) => (
                  ...
                  >
                    <div className="flex items-center justify-between w-full min-w-0 border bg-black/10 border-black rounded-[10px] px-3 py-2">
                      <p className="text-black text-xs truncate">{file.name}</p>
          ...
          <div className="space-y-3">
            <div>
              <input
                ...
                placeholder="mail"
                aria-required="true"
                className="w-full px-8 py-3 bg-white rounded-[10px] text-black placeholder:text-black"
                required
              />
            </div>
            <div className="flex items-center space-x-3">
              ...
              <button
                type="submit"
                disabled={isUploading}
                className="bg-red-dark text-white font-bold text-center w-full py-3 rounded-[10px] hover:bg-red-dark/90 transition-colors duration-300 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
