    ...
    <div className="space-y-2 2xl:space-y-3 py-1">
      ...
      <div className="grid grid-cols-2 gap-3">
        <input
          ...
          className="w-full px-4 py-2 bg-gray-100 rounded-lg text-black placeholder:text-black focus:outline-none focus:ring-2 focus:ring-red focus:ring-offset-0"
        />
        <input
          type="text"
          name="arranger"
      ...
      <textarea
        ...
        rows={4}
        className="w-full px-4 py-1.5 2xl:px-6 2xl:py-3 bg-gray-100 rounded-lg text-black placeholder:text-black resize-none focus:ring-2 focus:ring-red outline-none"
      />
    </div>
  );
}
