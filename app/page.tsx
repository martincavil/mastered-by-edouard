    ...
    <>
      <PageTransition>
        <main className="h-full flex flex-col justify-end relative">
          ...
          />
          <div className="space-y-4 md:space-y-13 relative z-10 w-full">
            <div className="px-4 md:px-8">
              <h1 className="text-4xl md:text-7xl font-medium leading-7 md:leading-none md:tracking-tight text-white text-shadow-lg">
                {t.home.title}
              </h1>
