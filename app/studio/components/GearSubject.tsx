...
export function GearTextContent() {
  return (
    <p className="uppercase leading-9 font-extralight text-2xl md:text-3xl xl:text-[40px]">
      <span className="text-red font-bold">MONITORING</span> ATC SCM50a SL,
      TRINNOV NOVA, SPL DMC, Ollo audio S4x, APPLE AIRPODS MAX, GIK acoustics{" "}
      <span className="text-red font-bold">HARDWARE</span> SPL PQ MASTERING,
      NEVE MASTER BUSS PROCESSOR, DANGEROUS BAX EQ, SPL Gemini
      <span className="text-red font-bold"> CONVERTER</span> Grimm UC1, Lavry
      Savitr <span className="text-red font-bold">SOFTWARE</span> AVID Protools,
      iZotope, Fabfilter, TOKYO DAWN LAB, SOFTUBE...
    </p>
  );
}

// Export image carousel separately
