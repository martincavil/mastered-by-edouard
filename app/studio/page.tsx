          ...
          <div className="flex-1 flex flex-col overflow-y-auto md:overflow-y-hidden">
            ...
            <div className="md:col-span-2 grid md:grid-cols-2 flex-1 min-h-0 items-center xl:max-h-[550px] 2xl:max-h-[600px]">
              ...
              <div
                ...
                className={`relative w-full h-full flex items-center ${selectedSubject === "edouard" ? "justify-center" : "justify-end pr-12"} order-0 md:order-1 mb-5 md:mb-0 animate-fade-in`}
              >
