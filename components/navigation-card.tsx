...
export function NavigationCard({
  ...
  return (
    <div className={`relative w-full flex ${className}`}>
      ...
      <Link
        href={href}
        className={`border  flex items-center justify-center py-4 md:py-10 w-full font-bold text-2xl md:text-4xl lg:text-5xl xl:text-7xl 2xl:text-[80px] relative z-10 rounded-[8px] transition-all hover:scale-[1.03]  duration-500 ${
          isAccent
