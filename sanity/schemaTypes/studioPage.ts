  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({
          name: "fullDiscography",
          title: "Voir toute la discographie",
          type: "localeString",
        }),
        defineField({
          name: "portraitImage",
          title: "Photo portrait (URL)",
          type: "url",
        }),
        defineField({
          name: "signatureImage",
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({
          name: "labelsRow1Image",
          title: "Logos labels - ligne 1 (URL)",
          type: "url",
        }),
        defineField({
          name: "labelsRow2Image",
          title: "Logos labels - ligne 2 (URL)",
          type: "url",
        }),
      ],
    }),
      ...
      of: [
        defineArrayMember({
          ...
          fields: [
            ...
            defineField({
              name: "description2",
              title: "Description (suite, optionnel)",
              type: "localeText",
            }),
            defineField({
              name: "logo",
              title: "Logo (URL, optionnel)",
              type: "url",
            }),
          ],
          preview: {
